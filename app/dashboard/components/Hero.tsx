  ...
  return (
    <section id="hero" className="relative text-center py-16 bg-[url('/heroo.png')] bg-cover bg-center text-white h-screen flex items-center justify-center overflow-hidden">
      <div className="flex flex-col items-center relative z-10">
        <img src="/logoo.png" alt="Hero Image" className="md:h-50 h-32 mb-6" />
        <h1 className="md:text-4xl text-2xl font-extrabold mb-4 mx-4">
          Selamat Datang di <span className="text-yellow-300">JobTracker</span>
        </h1>
        <p className="max-w-2xl mx-4 md:text-lg text-md text-blue-100 mb-6">
          Kelola semua lamaran kerja kamu di satu tempat. Tambahkan perusahaan, posisi, dan status dengan mudah!
        </p>
        <Link
          href="/add-job"
          className="bg-yellow-400 text-blue-900 font-semibold px-6 py-3 rounded-lg shadow hover:bg-yellow-300 transition md:text-lg text-sm mx-4"
        >
          + Tambah Lamaran Baru
        </Link>
      </div>
